...
# last update 2017.12.01 - KK

######################## User defined options ########################
######################################################################
# Main directory:
setwd("~/Rwork/1704-limma/170508-SUB-limma/") #Full path of the working directory. 
#It must contain: 
...
## Metadata options
metaFile <- "SUB-SP-meta-Nov.csv" #Name of metadata file in csv format.
doFilter <- T #F
...
countsFile <- "SUB-SP-est-counts-Nov-flipped.txt" #Name of metadata file
...
## Output
outDir = "SUB-SP-interaction-Nov-flip/"
dir.create(outDir, showWarnings=T)

sink('SUB-SP-interaction-Nov-test2/Output.txt')

geneListsDir = "SUB-SP-interaction-Nov-flip/GeneLists"
dir.create(geneListsDir, showWarnings=T)
#
imgDir = "SUB-SP-interaction-Nov-flip/images/"
